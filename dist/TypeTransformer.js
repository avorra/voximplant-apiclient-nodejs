...
TypeTransformer.fromActors = {
    ...
    PhoneNumberCountryRegionInfoType: function (data) {
        ...
        if (typeof data['phone_tax_reserve'] !== 'undefined')
            xData['phoneTaxReserve'] = TypeTransformer.to('number')(data['phone_tax_reserve']);
        if (typeof data['local_price'] !== 'undefined')
            xData['localPrice'] = TypeTransformer.to('number')(data['local_price']);
        if (typeof data['local_installation_price'] !== 'undefined')
            xData['localInstallationPrice'] = TypeTransformer.to('number')(data['local_installation_price']);
        if (typeof data['local_currency'] !== 'undefined')
            xData['localCurrency'] = TypeTransformer.to('string')(data['local_currency']);
        if (typeof data['account_price'] !== 'undefined')
            xData['accountPrice'] = TypeTransformer.to('number')(data['account_price']);
        if (typeof data['account_installation_price'] !== 'undefined')
            xData['accountInstallationPrice'] = TypeTransformer.to('number')(data['account_installation_price']);
        if (typeof data['account_currency'] !== 'undefined')
            xData['accountCurrency'] = TypeTransformer.to('string')(data['account_currency']);
        return xData;
    },
    ...
    ExchangeRates: function (data) {
        ...
        if (typeof data['KZT'] !== 'undefined')
            xData['KZT'] = TypeTransformer.to('number')(data['KZT']);
...
TypeTransformer.toActors = {
    ...
    PhoneNumberCountryRegionInfo: function (data) {
        ...
        if (typeof data['phoneTaxReserve'] !== 'undefined')
            xData['phone_tax_reserve'] = TypeTransformer.from('number')(data['phoneTaxReserve']);
        if (typeof data['localPrice'] !== 'undefined')
            xData['local_price'] = TypeTransformer.from('number')(data['localPrice']);
        if (typeof data['localInstallationPrice'] !== 'undefined')
            xData['local_installation_price'] = TypeTransformer.from('number')(data['localInstallationPrice']);
        if (typeof data['localCurrency'] !== 'undefined')
            xData['local_currency'] = TypeTransformer.from('string')(data['localCurrency']);
        if (typeof data['accountPrice'] !== 'undefined')
            xData['account_price'] = TypeTransformer.from('number')(data['accountPrice']);
        if (typeof data['accountInstallationPrice'] !== 'undefined')
            xData['account_installation_price'] = TypeTransformer.from('number')(data['accountInstallationPrice']);
        if (typeof data['accountCurrency'] !== 'undefined')
            xData['account_currency'] = TypeTransformer.from('string')(data['accountCurrency']);
        return xData;
    },
    MultipleNumbersPrice: function (data) {
        const xData = {};
    ...
    ExchangeRates: function (data) {
        ...
        if (typeof data['KZT'] !== 'undefined')
            xData['KZT'] = TypeTransformer.from('number')(data['KZT']);
        if (typeof data['EUR'] !== 'undefined')
